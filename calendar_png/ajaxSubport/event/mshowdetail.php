...
<?php 
	...
	?><div id='mdetail'>
	<font class='f-blue-big'><I><?php	echo $arr[man][manager_pname];?><?php	echo $arr[man][manager_name];?>  <?php	echo $arr[man][manager_sname];?></I></font>
	<br><font class='f-green-b'><I><?php	echo $dataOth->pos_($arr[man][manager_pos],$parts);?></I></font>
	</div>
	<div id='mpic'><img src='<?php echo $parts?>managerPic/<?php	echo $arr[man][manager_pic];?>' width='80'></div>
	&nbsp;<font class='f-red1-b'>วัน <?php	echo $conDate->DateConvertSH4($cdate,$parts);?></font>
