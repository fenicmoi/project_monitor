...
<div class="panel-group" id="accordion">
    ...
    <div class="panel panel-info">
      ...
      <div id="collapse2" class="panel-collapse collapse">
        <div class="panel-body">
            <a class="btn btn-primary btn-block" href="project_master.php"><i class="far fa-arrow-alt-circle-right  pull-left"></i>งบจังหวัด</a>
            <a class="btn btn-primary btn-block" href="buy.php" ><i class="far fa-arrow-alt-circle-right  pull-left"></i>งบกลุ่มจังหวัด</a>
