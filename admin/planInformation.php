...
?>
        ...
        <div  class="col-md-10">
            <div class="panel panel-default" >
                ...
                <i class="fas fa-anchor"></i>  <strong>ข้อมูลแผนพัฒนาจังหวัด</strong>
              ...
              <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content">
                  <div class="modal-header bg-primary">
                    ...
                    <h4 class="modal-title"><i class="fa fa-plus-circle"></i> เพิ่มข้อมูลแผนพัฒนาจังหวัด</h4>
                  </div>
                                ...
                                <td>
                                    <div class="form-group form-inline">
                                        ...
                                        <select class="form-control name="yid" id="yid">
                                            <?php  
                                                while ($row = dbFetchArray($result)) {  //แสดงปีปฏิทิน
                                                    echo "<option name='year'>".$row['yname']."</option>";
                                                }
                                            ?>
                                        </select>
                                    </div>
                            ...
                            <tr>
                                <td>
                                    <div class="form-group form-inline"> 
                                            ...
                                            <input class="form-control col-12" type="text" name="mission" id="mission">
                                    </div>   
                                </td>
                            </tr>
