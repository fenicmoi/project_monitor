...
<script>
		$(document).ready(function(){
			$(".example7").colorbox({width:"800", height:"600", iframe:true});
		});
</script>
...
<?php
	...
	$sql="SELECT * FROM ".TB_calendar." WHERE (
			( calendar_stdate between '".$stDate."' and '".$enDate."') 
			or ( calendar_endate between '".$stDate."' and '".$enDate."') 
			or ( calendar_stdate < '".$stDate."' and calendar_endate> '".$enDate."')
			
			)and calendar_status = 1 $condi";
	//print $sql;
