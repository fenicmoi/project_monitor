...
<?php
	...
	?>&nbsp;<img src='../images/printButton.png' onclick='javascript:window.print()' title='พิมพ์หน้านี้'>
			<table cellspacing="0" cellpadding="0" border='1' width="800">
				  <tr height=25>
				   <td align='center' colspan='4'><font class='f-blue-big1'><?php echo WEB_TITLE;?></font>
				   <?php 
				   		if($manager_id){
				...
				<br><font class='f-red1-big'>ประจำปี <?php echo ($nyear+543);?>  
				  ...
				  <tr height=25>
				   <td align='center' colspan='4'><font class='f-black'><?php echo word;?></font></td>
				  </tr>  
		‎
				  <tr height=25>
				...
				$sql="SELECT * FROM ".TB_calendar." where  (( calendar_stdate between '".$sdate."' and '".$endate."') or ( calendar_endate between '".$sdate."' and '".$endate."') or ( calendar_stdate < '".$sdate."' and calendar_endate> '".$endate."')) and calendar_endate ORDER BY calendar_stdate,calendar_sttime";
				//print $sql;
